__kernel void rotate3d(__global const float *input,__global const float *active,__global const float *passive,__global float *output,const int3 outShape)
{
	// // Get global xyz ID's.
